...
<Meta title="Welcome to Kajillion" />
...
<p style={{ fontSize: '1.75rem', lineHeight: '1.25em', marginTop: 0 }}>Welcome to <b>Kajillion</b> – a high-performance WebGL library for visualizing network graphs and machine learning embeddings.</p>
